return {
	...
	config = function()
		local trouble_providers = require 'trouble.sources.telescope'
		local telescope = require 'telescope'

		telescope.setup {
			defaults = {
				mappings = {
					i = { ['<leader>t'] = trouble_providers.open },
					n = { ['<leader>t'] = trouble_providers.open },
				},
			},
		}
	end,
	keys = {
		{ '<leader>xx', function() require('trouble').toggle() end, desc = 'Trouble: Open Trouble' },
